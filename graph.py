...
# class RobotTypeLineChart(QChartView):
#     def __init__(self, parent=None):
#         super().__init__(parent)
#         self.simulations_names = []

#         self.series1 = QtCharts.QLineSeries()
#         self.series1.setName('belt')
#         self.series2 = QtCharts.QLineSeries()
#         self.series2.setName('dump')
...
#         self.lineChart.setAnimationOptions(QtCharts.QChart.SeriesAnimations)
